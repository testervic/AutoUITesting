...
//                    + "chromedriver_v84");
            System.setProperty("webdriver.chrome.driver", "/Users/vic/work/WORK/Work/Py_script/sh_selenium_java_master/chromedriver_v84");
            System.out.println("test3--------");
            driver = new ChromeDriver();
            driver.manage().window().maximize();
            driver.navigate().to(appURL);
        } else {
            DesiredCapabilities desiredCaps = new DesiredCapabilities("chrome", chrome_version, Platform.MAC);
