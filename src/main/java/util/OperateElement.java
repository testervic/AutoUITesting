...
//                    System.out.println("点击了==" + testCase.getElement_info());
                    log.info("点击了：" + testCase.getElement_info());
                    break;
                }
                case "send_keys": {  //输入内容
...
//                    System.out.println(testCase.getElement_info() + ":输入内容：" + testCase.getText());
                    log.info("在该元素下："+testCase.getElement_info() + ",输入内容：" + testCase.getText());
                    break;
                }
                default:
//                    System.out.println("不支持操作方法=" + testCase.getElement_info());
//                    System.out.println("不支持操作方法=" + testCase.getOperate_type());
                    log.info("不支持操作方法：" + testCase.getElement_info());
            ...
            if (testCase.getFrame()!= null) { // 切换到frame
                ...
                log.info("testCase："+testCase.getFrame());
            }


        } else {
//            log.info(testCase.getElement_info()+"==元素不存在");
